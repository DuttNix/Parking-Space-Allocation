...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='demo_data/demo_data.mp4', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--parking_box_label', type=str, default='demo_data/demo_data.yaml', help='parking_box_label file')    
